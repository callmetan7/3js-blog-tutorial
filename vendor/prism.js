/* PrismJS 1.25.0
https://prismjs.com/download.html#themes=prism-dark&languages=markup+css+clike+javascript+bash+java+json+json5+python+shell-session&plugins=line-numbers+jsonp-highlight+highlight-keywords */
var _self =
